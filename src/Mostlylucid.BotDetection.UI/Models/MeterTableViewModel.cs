...
/// <summary>
///     View model for <c>SbMeterTable</c> -- the tabular meter listing used on the
///     <c>/dashboard/insights</c> global page and on per-pack hubs' "all meters
///     in this pack" panel. One row per meter; the sparkline lives in a dedicated
///     column so trend is visible without breaking the table grid.
/// </summary>
