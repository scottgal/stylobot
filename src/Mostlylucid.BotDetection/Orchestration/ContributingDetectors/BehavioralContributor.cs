...
///     Combines basic rate/pattern detection (BehavioralDetector) with statistical
///     entropy, timing anomaly, and burst analysis (formerly AdvancedBehavioralContributor).
...
public class BehavioralContributor : ConfiguredContributorBase
{
    ...
    // Config-driven parameters from YAML - basic behavioral
    private double BehavioralWeightMultiplier => GetParam("behavioral_weight_multiplier", 1.5);

    // Config-driven parameters from YAML - advanced behavioral (formerly AdvancedBehavioralContributor)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // === Part 2: Advanced statistical pattern detection ===
        ...
        try
        {
            ...
            // Read sequence signals from ContentSequenceContributor (Priority 4, runs before this at Priority 20).
