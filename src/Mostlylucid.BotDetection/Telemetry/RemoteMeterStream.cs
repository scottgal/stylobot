...
/// <summary>
///     DI extensions for <see cref="RemoteMeterStream" />. Registered by the
///     viewer host -- never the gateway, which uses <c>LocalMeterStream</c>
///     via its own <c>AddBotDetectionTelemetry</c> path.
/// </summary>
public static class RemoteMeterStreamServiceCollectionExtensions
{
    /// <summary>
    ///     Registers <see cref="RemoteMeterStream" /> as a singleton
    ///     <see cref="IMeterStream" /> + <see cref="IHostedService" />.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         This MUST NOT be combined with <c>AddBotDetectionTelemetry()</c>
